...
public class INFERIOR implements IAuto{
    ...
    public INFERIOR () {
        ...
        mpath1 = AutoTrajectoryReader.generateTrajectoryFromFile("pathplanner/paths/INF1.path", Constants.createTrajConfig(2, 2));
        mpath2 = AutoTrajectoryReader.generateTrajectoryFromFile("pathplanner/paths/INF2.path", Constants.createTrajConfig(2, 2)); 
        mpath3 = AutoTrajectoryReader.generateTrajectoryFromFile("pathplanner/paths/INF3.path", Constants.createTrajConfig(2, 2)); 
        mpath4 = AutoTrajectoryReader.generateTrajectoryFromFile("pathplanner/paths/INF4.path", Constants.createTrajConfig(2, 2)); 
